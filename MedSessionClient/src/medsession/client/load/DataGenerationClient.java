...
import medsession.client.thread.DataGenerationThread;
 ...
 *
 */
public class DataGenerationClient {
...
//			}
	...
	public synchronized static void report() {
		num++;
		System.out.println("[" + System.currentTimeMillis() + "] current number of complete threads: " + num);
	}
}
